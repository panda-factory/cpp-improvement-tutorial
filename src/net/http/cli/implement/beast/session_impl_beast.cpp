...
void SessionImplBeast::DoOneRequest() {
    ...
    request_.set(http::field::user_agent, "v0.0.1"); //TODO: add a way to override from user and make a version macro
...
void SessionImplBeast::SetUrl(const Url &url) {
    url_ = std::move(url);
}

void SessionImplBeast::SetParameters(const Parameters &parameters) {

}

void SessionImplBeast::SetParameters(Parameters &&parameters) {

}

void SessionImplBeast::SetHandler(const ResponseHandler&& onResponse) {

}

void SessionImplBeast::SetHeader(const Header &header) {

}

void SessionImplBeast::SetTimeout(const Timeout &timeout) {

}

void SessionImplBeast::SetAuth(const authentication &auth) {

}

void SessionImplBeast::SetDigest(const Digest &auth) {

}

void SessionImplBeast::SetMethod(const Method &method) {

}

void SessionImplBeast::SetMultipart(Multipart &&multipart) {

}

void SessionImplBeast::SetMultipart(const Multipart &multipart) {

}

void SessionImplBeast::SetRedirect(const bool &redirect) {

}

void SessionImplBeast::SetMaxRedirects(const MaxRedirects &max_redirects) {

}

void SessionImplBeast::SetCookies(const Cookies &cookies) {

}

void SessionImplBeast::SetBody(body &&body) {
